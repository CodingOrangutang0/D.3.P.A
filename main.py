...
import requests # This is to get a hold of the pictures and the .stl files
import pyautogui# this is to be able to automatically start the slicer. This version is dedicated to the ellegoo cura slicer.
